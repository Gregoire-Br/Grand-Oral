...
<html lang="en" dir="ltr">
	...
	<body>
		  <li class="nav-item">
		    <a class="nav-link active" id="tab-forms" data-toggle="tab" href="#forms" role="tab" aria-controls="forms" aria-selected="true">Formulaires</a>
		  </li>
		  <li class="nav-item">
		...
		<div class="tab-content" id="tabContent">
		  <div class="tab-pane fade show active" id="forms" role="tabpanel" aria-labelledby="forms-tab">
			  ...
			  <table class="table table-hover table-sm table-striped">
	  			...
	  			<tbody>
	  				<tr class="act-bad bg-danger text-white">
	  					<td>21/10/2022, 10h34</td>
	  					<td><b>M.DUPOND</b> a refusé la fiche de <b>Jean</b></td>
	  				</tr>
	  				<tr class="act-good bg-success text-white">
