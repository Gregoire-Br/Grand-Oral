  <h2>Insert CSV Data to MySql Table Output</h2>

<?php

/*Création de comptes utilisateurs "ENSEIGNANT" dans la BDD à l'aide un import CSV*/
...
//Ouverture du fichier x.CSV
if(($fileHandle = fopen("example.csv", "r")) !==FALSE);{

  $status = 1;
  $password = "";
  $username = "";

  while (list($firstname, $lastname, $email) = fgetcsv($fileHandle, 0, ';')){
